...
#加载ood数据
df=pd.read_excel('/root/autodl-tmp/ADMETood/ood/demo/data_load/confi_03.xlsx')
...
for line in list_data:
    ...
    if s=='EC50':
        ...
        kdd.append(line)
#加载iid数据
df=pd.read_excel('/root/autodl-tmp/ADMETood/ood/demo/data_load/confi_9.xlsx')
json_data=df.to_json(orient='records')
list_data=json.loads(json_data)
ecc1=[]
icc1=[]
...
def  dataload(name,name1,nnn):
    ...
    import json
    import os
    json_file_name='/root/autodl-tmp/ADMETood/ood/demo/data_new/confi_'+nnn+'_scaffold1.json'
