...
for seed in ss:
    for  nnname in data_name:
        ...
        m_name='/root/autodl-tmp/ADMETood/ood/configs/algorithms/coral/'+nnname+'_coral.py'
        ...
        cfg.seed=seed
        cfg.gpu_ids=range(1)
        w_name='/root/autodl-tmp/ADMETood/ood/demo/work_CORAL1/work_dirs1/'+nnname+'_'+str(seed)
        cfg.work_dir=w_name
