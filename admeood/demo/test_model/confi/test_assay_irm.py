...
for seed in ss:
    for  nnname in data_name:
        l_name="/root/autodl-tmp/ADMETood/ood/demo/data_new/"+nnname+'.json'
        data=mmcv.load(l_name)
        m_name='/root/autodl-tmp/ADMETood/ood/configs/algorithms/irm/'+nnname+'_irm.py'
        ...
        cfg.seed=seed
        cfg.gpu_ids=range(1)
        w_name='/root/autodl-tmp/ADMETood/ood/demo/work_IRM/work_dirs/'+nnname+'_'+str(seed)
        cfg.work_dir=w_name
