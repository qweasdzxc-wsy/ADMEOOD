...
data_name=["label_potency_scaffold"]
ss=[2019]
ood_val_auc=[]
iid_val_auc=[]
...
for seed in ss:
    for  nnname in data_name:
        ...
        m_name='/data/wsy22/code/ADMETood/ood/configs/algorithms/erm/'+nnname+'_erm.py'
        ...
        cfg.seed=seed
        cfg.gpu_ids=range(1)
        w_name='/data/wsy22/code/ADMETood/ood/demo/work_dirs/GAT/label/ERM/work_dirs_scaffold/'+nnname+'_'+str(seed)
        cfg.work_dir=w_name
