...
data_name=["label_KI_core","label_potency_core"]
ss=[2019]
ood_val_auc=[]
iid_val_auc=[]
...
for seed in ss:
    for  nnname in data_name:
        l_name="/data_1/wsy22/ADMETood/ood/demo/data_new/"+nnname+'.json'
        data=mmcv.load(l_name)
        m_name='/data_1/wsy22/ADMETood/ood/configs/algorithms/erm/'+nnname+'_erm.py'
        ...
        cfg.seed=seed
        cfg.gpu_ids=range(1)
        w_name='/data_1/wsy22/ADMETood/ood/demo/work_dirs/GCN/work_dirs/'+nnname+'_'+str(seed)
        cfg.work_dir=w_name
