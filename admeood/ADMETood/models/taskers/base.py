...
from ADMETood.core.visualization import imshow_infos

# TODO import `auto_fp16` from mmcv and delete them ADMETood
try:
    from mmcv.runner import auto_fp16
except ImportError:
    warnings.warn('auto_fp16 ADMETood will be deprecated.'
                  'Please install mmcv>=1.1.4.')
    from ADMETood.core import auto_fp16
